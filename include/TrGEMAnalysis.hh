...
class TrGEMAnalysis {
    ...
    public:
        ...
        void SaveDriftRegion(std::string pProcess, G4int index);
        void SaveGenRegion(G4int id, std::string gProcess, std::string gVolume);
        
        // void SaveGamma(G4int id);
    ...
    private:
        ...
        //for drift region
        std::vector<std::string> driftProcess;
        std::vector<std::string> driftProcessWithoutTransportation;
        std::vector<std::string> driftTransportation;
        std::vector<std::string> driftProcessByPrimary;
        std::vector<std::string> driftProcessBySecondary;

        std::vector<std::string> driftGenProcess;
        std::vector<std::string> driftGenVolume;

        std::vector<std::string> secondaryParticle;
        std::vector<G4double> secondaryGammaE;
